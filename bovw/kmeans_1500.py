...
deses = np.load("D:\\592\\image_classification_using_sift\\cancer\\sift\\normal\\"+ "sift_final"  + ".npy")
...
# centers, indices = kmeans_plusplus(deses, n_clusters=300)
# print('kmeans cluster done')
# np.save("D:\\592\\image_classification_using_sift\\cancer\\sift\\normal\\"+ "sift_cv10_k300"  + ".npy", centers)

# centers, indices = kmeans_plusplus(deses, n_clusters=500)
# print('kmeans cluster done')
# np.save("D:\\592\\image_classification_using_sift\\cancer\\sift\\normal\\"+ "sift_cv10_k500"  + ".npy", centers)

# centers, indices = kmeans_plusplus(deses, n_clusters=700)
# print('kmeans cluster done')
# np.save("D:\\592\\image_classification_using_sift\\cancer\\sift\\normal\\"+ "sift_cv10_k700"  + ".npy", centers)

# centers, indices = kmeans_plusplus(deses, n_clusters=1000)
# print('kmeans cluster done')
# np.save("D:\\592\\image_classification_using_sift\\cancer\\sift\\normal\\"+ "sift_cv10_k1000"  + ".npy", centers)

centers, indices = kmeans_plusplus(deses, n_clusters=1500)
print('kmeans cluster done')
np.save("D:\\592\\image_classification_using_sift\\cancer\\sift\\normal\\"+ "sift_final_k1500"  + ".npy", centers)