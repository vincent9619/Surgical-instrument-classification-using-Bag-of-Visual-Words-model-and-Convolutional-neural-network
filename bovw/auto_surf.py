...
for count in range(1,11):
    ...
    for nor in norm:
        for n in k_range:
            ...
            centers = np.load("Temp/surf_add/surf_add_kmean"+ "cross" + str(count) + "k" + str(n) + ".npy")
            ...
            f = open("I:\image_classification_using_sift\manual_cross\surf_add\\" + "cross" + str(count)+"surf_add_svm_5_record.txt",'a', encoding='utf-8')
            space = "********************************************************\n"
